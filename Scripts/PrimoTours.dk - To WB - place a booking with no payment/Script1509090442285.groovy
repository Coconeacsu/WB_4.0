...
WebUI.scrollToElement(findTestObject('Coco/PrimoT/Page_Charter rejser med Primo Tours/span_jquery-select-trigger-arr'), 
    10)

WebUI.waitForElementClickable(findTestObject('Coco/PrimoT/Page_Charter rejser med Primo Tours/span_jquery-select-trigger-arr'), 
    10)

WebUI.click(findTestObject('Coco/PrimoT/Page_Charter rejser med Primo Tours/span_jquery-select-trigger-arr'))

WebUI.scrollToElement(findTestObject('Coco/PrimoT/Page_Charter rejser med Primo Tours/a_Kreta'), 3)

WebUI.waitForElementVisible(findTestObject('Coco/PrimoT/Page_Charter rejser med Primo Tours/a_Kreta'), 3)

'Choose departure resort'
WebUI.click(findTestObject('Coco/PrimoT/Page_Charter rejser med Primo Tours/a_Kreta'))

'Click search on Primotours.dk'
WebUI.click(findTestObject('Coco/PrimoT/Page_Charter rejser med Primo Tours/button_Find drmmerejsen'))

WebUI.waitForPageLoad(3)

not_run: WebUI.waitForElementClickable(findTestObject('Coco/PrimoT/SaveBooking2/Success/a_Book her'), 10)

not_run: WebUI.scrollToElement(findTestObject('Coco/PrimoT/SaveBooking2/Success/a_Book her'), 10)

WebUI.waitForElementVisible(findTestObject('Coco/PrimoT/SaveBooking2/Success/a_Book her'), 10)

WebUI.waitForElementClickable(findTestObject('Coco/PrimoT/SaveBooking2/Success/a_Book her'), 10)

not_run: WebUI.scrollToElement(findTestObject('Coco/PrimoT/SaveBooking2/Success/a_Book her'), 10)

'Click "Book" on Primotours.dk offer'
WebUI.click(findTestObject('Coco/PrimoT/SaveBooking2/Success/a_Book her'))
...
WebUI.setText(findTestObject('Coco/PrimoT/Page_Primo Tours  Danmarks bedste c/input_lastName'), 'Neacsu')
